...
const build = gulp.series(clean, copy, sprite, stackSvg, gulp.parallel(compileMinStyles, compileMainMinScripts, compileVendorScripts, optimizePng, optimizeJpg, optimizeSvg));
const dev = gulp.series(clean, copy, sprite, stackSvg, gulp.parallel(compileMinStyles, compileMainMinScripts, compileVendorScripts, optimizePng, optimizeJpg, optimizeSvg), syncServer);
const start = gulp.series(clean, copy, sprite, stackSvg, gulp.parallel(compileStyles, compileMainScripts, compileVendorScripts), syncServer);
